...
3. Back-End
     - Go to the "BackEnd" folder and activate the python virtual environment using ```python -n venv fastmlbackend```
     - To activate the environment do this ```.\fastmlbackend\Scripts\activate```
